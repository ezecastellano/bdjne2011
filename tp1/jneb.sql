...
--
INSERT INTO `control` (`id`,`chofer`,`viaje`,`tipo`,`resultado`,`fecha`) VALUES 
 (1,34496723,6,1,'NEGATIVO','2008-11-05'),
 (2,34496723,6,2,'POSITIVO','2011-10-10'),
 (3,33333333,4,3,'NEGATIVO','2011-01-01');

--
-- Definition of table `control_asignacion_chofer`
--
...
--
-- Definition of table `observacion_licencia`
--
...
--
-- Definition of table `realizacion_viaje`
--
...
--
-- Definition of table `realizacion_viaje_chofer`
--
...
--
-- Definition of table `tipo_contingencia`
--
...
--
-- Definition of table `tipo_control`
--
...
--
-- Definition of table `viaje_chofer`
--
...
--
-- Definition of procedure `choferesQueManejaronTodosLosNuevos`
--
...
--
-- Definition of procedure `recorridosConTodasRutasUsadas`
--
...
--
-- Definition of procedure `viajesRealizadosYEstadoPorVehiculo`
--
